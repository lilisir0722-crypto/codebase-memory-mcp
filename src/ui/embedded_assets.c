...
extern const unsigned char _binary_assets_index_CXGcb5AF_css_data[];
extern const unsigned int _binary_assets_index_CXGcb5AF_css_size;
extern const unsigned char _binary_assets_index_D4itFTv__js_data[];
extern const unsigned int _binary_assets_index_D4itFTv__js_size;
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-CXGcb5AF.css", _binary_assets_index_CXGcb5AF_css_data, 0, "text/css"},
    {"/assets/index-D4itFTv-.js", _binary_assets_index_D4itFTv__js_data, 0,
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = _binary_assets_index_CXGcb5AF_css_size;
    files[1].size = _binary_assets_index_D4itFTv__js_size;
